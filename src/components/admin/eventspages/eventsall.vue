...
const filteredEvents = computed(() => {
  ...
  return eventsWithDynamicStatus.filter(
    (event) => event.status === currentFilter.value,
  );
});
</script>
...
<template>
  <main class="w-full font-poppins pt-8">
    <div class="w-full max-w-5xl mx-auto px-6">
      ...
      <div
        class="bg-[rgba(255,255,255,0.06)] rounded-4xl border border-[rgba(255,255,255,0.12)] px-8 py-5 mb-4 shadow-lg"
      >
        ...
        >
          ...
          <div class="col-span-4 flex items-center gap-8">
            <div class="flex flex-col items-center">
              <span
                class="text-white text-[22px] font-semibold leading-none tracking-wide"
                >{{ event.scans || 0 }}</span
              >
          ...
          <div class="col-span-3 flex items-center justify-end gap-3">
            <button 
              ...
              class="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#52806B]/20 border border-[#52806B]/60 text-[#9FC2B0] text-[11px] font-medium hover:bg-[#52806B]/40 transition cursor-pointer"
            >
              <svg
                class="w-3.5 h-3.5"
                fill="none"
            ...
            <button
              class="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#5D87A8]/20 border border-[#5D87A8]/60 text-[#A2C7E2] text-[11px] font-medium hover:bg-[#5D87A8]/40 transition cursor-pointer"
            >
              <svg
                class="w-3.5 h-3.5"
                fill="none"
