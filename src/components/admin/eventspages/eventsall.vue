    ...
    <div class="w-full max-w-5xl mx-auto px-6">
      ...
      <section class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div class="flex space-x-3">
          <button 
            ...
            :class="['px-6 py-2 rounded-full text-sm font-medium border border-[#3E5249] transition cursor-pointer', currentFilter === 'All Events' ? 'bg-[#2A3F35] text-white shadow-sm' : 'text-gray-300 hover:text-white hover:bg-[#2A3F35]']"
          >
            All Events
          </button>
          <button 
            @click="currentFilter = 'Active'"
            :class="['px-6 py-2 rounded-full text-sm font-medium border border-[#3E5249] transition cursor-pointer', currentFilter === 'Active' ? 'bg-[#2A3F35] text-white shadow-sm' : 'text-gray-300 hover:text-white hover:bg-[#2A3F35]']"
          >
            Active
          </button>
          <button 
            @click="currentFilter = 'Completed'"
            :class="['px-6 py-2 rounded-full text-sm font-medium border border-[#3E5249] transition cursor-pointer', currentFilter === 'Completed' ? 'bg-[#2A3F35] text-white shadow-sm' : 'text-gray-300 hover:text-white hover:bg-[#2A3F35]']"
          >
            Completed
          </button>
          <button 
            @click="currentFilter = 'Upcoming'"
            :class="['px-6 py-2 rounded-full text-sm font-medium border border-[#3E5249] transition cursor-pointer', currentFilter === 'Upcoming' ? 'bg-[#2A3F35] text-white shadow-sm' : 'text-gray-300 hover:text-white hover:bg-[#2A3F35]']"
          >
            Upcoming
          </button>
        </div>
      ...
      <div class="bg-[rgba(255,255,255,0.06)] rounded-4xl border border-[rgba(255,255,255,0.12)] px-8 py-5 mb-4 shadow-lg">
        <div class="grid grid-cols-12 gap-4 items-center">
          ...
          <div class="col-span-3 text-white text-lg font-medium text-right">Actions</div>
        </div>
      </div> 
      ...
      <div class="bg-[rgba(255,255,255,0.06)] rounded-4xl border border-[rgba(255,255,255,0.12)] p-4 shadow-lg flex flex-col gap-2">
        ...
        >
          ...
          <div class="col-span-3 flex items-center justify-end gap-3">
            <button class="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#52806B]/20 border border-[#52806B]/60 text-[#9FC2B0] text-[11px] font-medium hover:bg-[#52806B]/40 transition cursor-pointer">
            ...
            <button class="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#5D87A8]/20 border border-[#5D87A8]/60 text-[#A2C7E2] text-[11px] font-medium hover:bg-[#5D87A8]/40 transition cursor-pointer">
              <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
